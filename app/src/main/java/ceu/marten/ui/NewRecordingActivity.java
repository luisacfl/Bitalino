...
import ceu.marten.services.GPSService;
...
public class NewRecordingActivity extends OrmLiteBaseActivity<DatabaseHelper> implements android.widget.PopupMenu.OnMenuItemClickListener, OnSharedPreferenceChangeListener {
	...
	private void stopRecording(){
		...
		stopService(new Intent(NewRecordingActivity.this, GPSService.class));
				...
				runOnUiThread(new Runnable(){
				    public void run(){
						...
						if(connectionError){
							...
							Intent intentGPS = new Intent(classContext, GPSService.class);
	...
	/*void bindToGPSService(){
		Intent intent = new Intent(classContext, GPSService.class);
		bindService(intent, bindConnection, 0);
	}*/
